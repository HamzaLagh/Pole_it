...
Encore
    ...
    .addEntry('posts-detail', './assets/posts-detail.js')
    .addEntry('add-image-post', './assets/add-image-post.js')
    ...
    .addEntry('publication', './assets/publication-box.js')
    .addEntry('emoji', './assets/emojionearea.min.js')
    .addEntry('control-emoji', './assets/control-emoji.js')
    .addEntry('contact', './assets/contact.js')
    .addEntry('about', './assets/about.js')
    .addEntry('url-detect', './assets/detect-url.js')
    .addEntry('activite', './assets/activite.js')
